        ...
        <tbody>
            @foreach($rekings as $index => $rekening)
                <tr>
                    ...
                    <td>
                    <a href="{{ route('manage.data.rekening.edit', $rekening->id_rekening) }}" class="btn btn-warning btn-edit">Edit</a>
                    <button class="btn btn-danger btn-delete" data-toggle="modal" data-target="#confirmDeleteModal" data-id="{{ $rekening->id_rekening }}">Hapus</button>
                </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('manage.data.rekening.destroy', $rekening->id_rekening) }}" style="display: inline;">
                        @csrf
                        @method('DELETE')
